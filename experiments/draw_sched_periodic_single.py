...
for i in range(1, 2):
    ...
    ax.plot(x1, y1, color='red', label='NOM-EDF', linewidth=2.0, marker='D', markersize=18, markevery=1, fillstyle='none')
    ax.plot(x2, y2, color='red', label='NOM-RM', linewidth=2.0, marker='o', markersize=18, markevery=1, fillstyle='none')
